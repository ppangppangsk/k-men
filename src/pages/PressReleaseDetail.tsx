  ...
  if (!post) {
    return (
      <div className="pt-44 pb-24 text-center">
        <p className="text-slate-400 text-lg mb-4">보도자료를 찾을 수 없습니다.</p>
        <Link to="/press-release" className="text-kmen-orange hover:underline">
          보도자료 목록으로 돌아가기
        </Link>
      </div>
    );
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        >
          ...
          <header className="mb-10">
            <span className="inline-block px-3 py-1 bg-kmen-orange/10 text-kmen-orange rounded-full text-xs font-medium mb-4">
              보도자료
            </span>
