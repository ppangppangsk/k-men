...
export const members: Member[] = [
  { name: '남다른성교육연구소', url: 'https://namdareunboys.com/' },
  { name: '남성과함께하는페미니즘', url: 'https://www.femiwithhim.kr/' },
  { name: '사회적돌봄센터 봄돌' },
  { name: '성매매문제해결을위한전국연대', url: 'https://jkyd2004.org/' },
  { name: '성문화연구소 라라', url: 'https://www.lalaschool.kr/' },
  ...
  { name: '한국NVC센터', url: 'https://www.krnvc.org/' },
];
